...
export const contactInfo = [
  {
    icon: Phone,
    text: "1-888-PREMGANGA (1-888-633-4227)",
  },
  {
    icon: Mail,
    text: "support@premganga-plus.com",
  },
  {
    icon: MapPin,
...
export const socials = [
  { name: "twitter", icon: Twitter, url: "https://twitter.com/premganga-plus" },
  { name: "facebook", icon: Facebook, url: "https://facebook.com/premganga-plus" },
  { name: "linkedin", icon: Linkedin, url: "https://linkedin.com/company/premganga-plus" },
  { name: "instagram", icon: Instagram, url: "https://instagram.com/premganga-plus"},
]
