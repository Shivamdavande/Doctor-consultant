          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
            ...
            <div className='lg:col-span-4'>
              <div className='flex items-center space-x-2 mb-6'>
                ...
                <span className="text-2xl font-bold bg-gradient-to-br from-white to-blue-100 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
              <input
                ...
                className="w-full sm:w-[280px] px-4 py-3 rounded-lg bg-blue-800/50 border border-blue-600 text-white placeholder:text-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
              />

              <Button className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-lg whitespace-nowrap">
                Subscribe
              </Button>
            </div>
